...
class DonateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('NAA-Donate.Donate',compact('email','message','donationAmount','workWithUs','getLegalAdvice','advirtiseWithUs','publishWithUs','takePicture','Donate','WatchEpisodes','butAbook','translate','other'));
    }
    ...
    public function create(Request $request)
    {
        ...
        if (request('id')) {
             ...
             if (isset($payment_status['id'])) { //success payment id -> transaction bank id
                 ...
                 $data->donationAmount = $payment_status['amount'];
               ...
               return view('NAA-Donate.create', compact('email','message','donationAmount','workWithUs','getLegalAdvice','advirtiseWithUs','publishWithUs','takePicture','Donate','WatchEpisodes','butAbook','translate','other'))-> with(['success' =>  'تم الدفغ بنجاح']);
           } else {
       ...
       return view('NAA-Donate.create', compact('email','message','donationAmount','workWithUs','getLegalAdvice','advirtiseWithUs','publishWithUs','takePicture','Donate','WatchEpisodes','butAbook','translate','other'));
