    ...
    <section class="home">
      ...
      <div class="welcome">
        ...
        @endif
          ...
          <div class="btns">
            <a class="specBtn" href="{{route('NAA-ContactUS.create', [$email,$message,$workWithUs,$getLegalAdvice,$publishWithUs,$takePicture,$Donate,$WatchEpisodes,$butAbook,$translate, $other])}}" id="contactBtn" data-text="contact">pay Now</a>
        </div>
